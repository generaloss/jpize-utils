...
public class FloatList implements Iterable<Float> {
    ...
    public void addAll(FloatBuffer buffer) {
        for(int i = buffer.position(); i < buffer.limit(); i++)
            this.add(buffer.get(i));
    }

    public void addAll(Iterable<Float> iterable) {
    ...
    public <T> void addAll(Iterable<T> iterable, Function<T, Float> func) {
        for(T object: iterable)
            this.add(func.apply(object));
    }

    public <T> void addAll(Collection<T> collection, Function<T, Float> func) {
        for(T object: collection)
            this.add(func.apply(object));
    }

    public <T> void addAll(T[] array, Function<T, Float> func) {
        for(T object: array)
            this.add(func.apply(object));
    }
