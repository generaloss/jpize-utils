...
public class ObjectList implements Iterable<Object> {
    ...
    public void add(int i, Object... elements) {
    ...
    public <T> void addAll(Iterable<T> iterable, Function<T, Object> func) {
        for(T object: iterable)
            this.add(func.apply(object));
    }

    public <T> void addAll(Collection<T> collection, Function<T, Object> func) {
        for(T object: collection)
            this.add(func.apply(object));
    }

    public <T> void addAll(T[] array, Function<T, Object> func) {
        for(T object: array)
            this.add(func.apply(object));
    }
    ...
    public void removeLast(Object value) {
    ...
    public void copyTo(Object[] dst, int offset, int length) {
        System.arraycopy(array, 0, dst, offset, length);
    }

    public void copyTo(Object[] dst, int offset) {
