...
public class LongList implements Iterable<Long> {
    ...
    public void addAll(LongBuffer buffer) {
    ...
    public <T> void addAll(Iterable<T> iterable, Function<T, Long> func) {
        for(T object: iterable)
            this.add(func.apply(object));
    }

    public <T> void addAll(Collection<T> collection, Function<T, Long> func) {
        for(T object: collection)
            this.add(func.apply(object));
    }

    public <T> void addAll(T[] array, Function<T, Long> func) {
        for(T object: array)
            this.add(func.apply(object));
    }
    ...
    public void removeFirst(long value) {
        final int index = indexOf(value);
        if(index > -1)
            remove(index);
    }

    public void removeLast(long value) {
