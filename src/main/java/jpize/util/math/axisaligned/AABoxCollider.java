...
public class AABoxCollider {
    ...
    private static float minClipX(float movementX, AABoxBody body1, AABoxBody[] otherBodies) {
    ...
    private static float clipX(float movementX, AABoxBody body1, AABoxBody body2) {
        ...
        if(body2.getMax().y > body1.getMin().y && body2.getMin().y < body1.getMax().y && body2.getMax().z > body1.getMin().z && body2.getMin().z < body1.getMax().z){
    ...
    private static float clipY(float movementY, AABoxBody body1, AABoxBody body2) {
        if(body2.getMax().x > body1.getMin().x && body2.getMin().x < body1.getMax().x && body2.getMax().z > body1.getMin().z && body2.getMin().z < body1.getMax().z){
    ...
    private static float clipZ(float movementZ, AABoxBody body1, AABoxBody body2) {
        if(body2.getMax().x > body1.getMin().x && body2.getMin().x < body1.getMax().x && body2.getMax().y > body1.getMin().y && body2.getMin().y < body1.getMax().y){
